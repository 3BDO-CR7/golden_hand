...
import {Container, Content, Icon, Header, Left, Button, Body, Title, Form, Item, Input, Textarea, Picker, Toast,ActionSheet} from 'native-base'
...
let base64   = [];
let BUTTONS = [
    { text:  i18n.t('gallery_photo') ,i : 0 },
    { text:  i18n.t('camera_photo'),i : 1},
    { text:  i18n.t('cancel'),   color: "#ff5b49" }
];
        ...
        ActionSheet.show(
            {
                ...
                title: i18n.t('image_cam')
            },
            buttonIndex => {
                this.get_images(BUTTONS[buttonIndex])

            }
        )
    };

  async  get_images(index){
        if(index.i === 0){
        ...
        return(
            <View style={[ styles.flex_45, styles.position_R , styles.marginHorizontal_5, styles.marginVertical_10]}>
                ...
                <TouchableOpacity
                    ...
                    style       = {[styles.position_A , styles.overlay_transBrown, styles.Width_100, styles.heightFull, styles.flexCenter]}
                >
                    <Icon type={'EvilIcons'} name={'close'} style={[styles.text_White, styles.textSize_20]} />
                </TouchableOpacity>
                <TouchableOpacity
